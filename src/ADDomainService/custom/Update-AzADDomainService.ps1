    ...
    begin {
        try {
            ...
            if ($PSBoundParameters.ContainsKey('LdapSetting')) {
                ...
                $PSBoundParameters['LdapSettingLdap'] = $PSBoundParameters['DomainSecuritySetting'].Ldap
                $PSBoundParameters['LdapSettingPfxCertificate'] = $PSBoundParameters['DomainSecuritySetting'].PfxCertificate
                $PSBoundParameters['LdapSettingPfxCertificatePassword'] = $PSBoundParameters['DomainSecuritySetting'].PfxCertificatePassword
            }
